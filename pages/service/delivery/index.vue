<template>
  <section class="container">
    ...
    <div class="container__inner container__body service-delivery">
      <h2>
        <svg-icon name="clock" style="width: 2rem; height: 2rem; margin-right: 1.6rem;"/>
        В разработке
      </h2>
    </div>
  </section>
...
<script>
  ...
  export default {
    ...
    components: { ReviewsTabs, ServiceSubTabs },
  }
</script>
