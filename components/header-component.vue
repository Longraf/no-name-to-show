<template>
    ...
    <div class="header__wrapper">
      ...
      <div class="header-mobile-container">
        <button type="button" aria-label="general-page-link" class="header-mobile-container__toggle" @click="ToggleMobileMenu(!MobileMenuState)">
          <span />
          <span />
        </button>
        <nuxt-link class="header-mobile-container__logo" aria-label="home-page" to="/">
          <svg-icon name="aside-logo--big"/>
        </nuxt-link>
      </div>
      <p class="header__title">
        <span>lorem ipsum
        </span><span>lorem </span>
        <span>lorem</span>
      </p>
      <div class="header-options">
        ...
        <nuxt-link aria-label="notification-page" class="header-options__option header-options-notification none" to="/notifications"
        ...
        <nuxt-link aria-label="user-page" class="header-options__option" to="/user/balance" title="Мой профиль"
          :active-class="'header-options__link--active'">
          <svg-icon name="header--user" />
        </nuxt-link>
        <button type="button" aria-label="Выйти (прекратить сеанс работы в качестве зарегистрированного пользователя)" title="Выход" class="header-options__option header-options__logout" @click="LogoutUser">
