<template>
    ...
    <div class="sidebar__head">
      <nuxt-link aria-label="home-page" class="sidebar__head-link" to="/" >
      ...
      <button type="button" aria-label="toggle-sidebar" class="sidebar__toggle" @click="ToggleSidebar(!SidebarState)">
